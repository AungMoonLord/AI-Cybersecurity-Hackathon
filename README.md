...
| Name                                                                                                            | Purpose                                                       |
| --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [AungMoonLord/bert-log-anomaly-detection](https://huggingface.co/AungMoonLord/bert-log-anomaly-detection)                           | Fine-tuned classification inference model on transaction logs |
